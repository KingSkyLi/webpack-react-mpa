...
Ripples.prototype = {
	...
	computeTextureBoundaries: function() {
		...
		if (backgroundAttachment == 'fixed') {
			var container1 = { left: window.pageXOffset, top: window.pageYOffset };
			container1.width = $window.width();
			container1.height = $window.height();
		}
		else {
			var container2 = this.$el.offset();
			container2.width = this.$el.innerWidth();
			container2.height = this.$el.innerHeight();
        }
